...
if st.sidebar.button("Run Backtest"):
    ...
    # Load trade log
    df_trades = pd.read_csv("backtest_trades.csv")
    ...
    fig_line = go.Figure()
    fig_line.add_trace(go.Scatter(x=result["balance_curve"]["dates"], y=result["balance_curve"]["balances"], mode='lines', name='Total Account Value', line=dict(color='blue')))
